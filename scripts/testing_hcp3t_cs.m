...
%% output filenames.
% bins_10_proc_regress_fix_ts_mat_scan_REST1_LR_hcpmmp_hfd_0_regress_cofounds_0.mat
% bins_10_proc_regress_fix_ts_mat_scan_REST1_LR_hcpmmp_hfd_0_regress_cofounds_1.mat
% bins_10_proc_regress_fix_ts_mat_scan_REST1_LR_schaefer200_hfd_0_regress_cofounds_0.mat
% bins_10_proc_regress_fix_ts_mat_scan_REST1_LR_schaefer200_hfd_0_regress_cofounds_1.mat
% bins_10_proc_regress_fix_ts_mat_scan_REST1_LR_schaefer400_hfd_0_regress_cofounds_0.mat
% bins_10_proc_regress_fix_ts_mat_scan_REST1_LR_schaefer400_hfd_0_regress_cofounds_1.mat
% 
% bins_10_proc_regress_fixWglob_ts_mat_scan_REST1_LR_hcpmmp_hfd_0_regress_cofounds_0.mat
% bins_10_proc_regress_fixWglob_ts_mat_scan_REST1_LR_hcpmmp_hfd_0_regress_cofounds_1.mat
% bins_10_proc_regress_fixWglob_ts_mat_scan_REST1_LR_schaefer200_hfd_0_regress_cofounds_0.mat
% bins_10_proc_regress_fixWglob_ts_mat_scan_REST1_LR_schaefer200_hfd_0_regress_cofounds_1.mat
% bins_10_proc_regress_fixWglob_ts_mat_scan_REST1_LR_schaefer400_hfd_0_regress_cofounds_0.mat
% bins_10_proc_regress_fixWglob_ts_mat_scan_REST1_LR_schaefer400_hfd_0_regress_cofounds_1.mat
% 
% bins 20 and 40 ......
% 
% bins_20_proc_regress_fixWglob_ts_mat_scan_REST1_LR_schaefer200_hfd_0_regress_cofounds_1_tSNR.mat
% bins_20_proc_regress_fixWglob_ts_mat_scan_REST1_RL_schaefer200_hfd_0_regress_cofounds_1_tSNR.mat
% bins_20_proc_regress_fixWglob_ts_mat_scan_REST2_LR_schaefer200_hfd_0_regress_cofounds_1_tSNR.mat
% bins_20_proc_regress_fixWglob_ts_mat_scan_REST2_RL_schaefer200_hfd_0_regress_cofounds_1_tSNR.mat
% 
% N_G_RSS_20_proc_regress_fix_ts_mat__scan_REST1_LR_schaefer200_hfd_1.mat
% N_G_RSS_20_proc_regress_fix_ts_mat__scan_REST1_RL_schaefer200_hfd_1.mat
% N_G_RSS_20_proc_regress_fix_ts_mat__scan_REST2_LR_schaefer200_hfd_1.mat
% N_G_RSS_20_proc_regress_fix_ts_mat__scan_REST2_RL_schaefer200_hfd_1.mat
% N_G_RSS_20_proc_regress_fixWglob_ts_mat__scan_REST1_LR_schaefer200_hfd_1.mat
% N_G_RSS_20_proc_regress_fixWglob_ts_mat__scan_REST1_RL_schaefer200_hfd_1.mat
% N_G_RSS_20_proc_regress_fixWglob_ts_mat__scan_REST2_LR_schaefer200_hfd_1.mat
% N_G_RSS_20_proc_regress_fixWglob_ts_mat__scan_REST2_RL_schaefer200_hfd_1.mat


%% new settings.

% high_fd = [1, 0] % 是否移除高头动帧，1保留，0移除
% num_of_bins=[10, 20, 40]
% atlas_i=1:3
% regress_cofounds=[1, 0] % 1: regress, 0: skip.
% gsr=[1, 0] % 1: with GSR, 0: no GSR.
...
meta_analysis_plotData=readmatrix("G:\PycharmProjects\MyPython\src\meta_analysis/plotData.csv");
meta_analysis_plotData(:, 1) = [];
meta_analysis_labels = readtable("G:\PycharmProjects\MyPython\src\meta_analysis/plotData.csv");
labels = meta_analysis_labels.Var1;
% plot.
figure;
set(gcf, 'PaperUnits', 'inches');
set(gcf, 'PaperPosition', [0 0 3 5]);
imagesc(meta_analysis_plotData);
cmp = gray;
cmp = flipud(cmp);
colormap(cmp);
hold on;
ax = gca;
ax.Box = 'off';        % 关掉外框
ax.XAxis.Visible = 'on';  % 保留坐标轴
ax.YAxis.Visible = 'on';  % 保留坐标轴
ax.FontSize=11;
set(gca, 'XTick', [1, 5, 10, 15, 20], 'TickDir', 'none', ...
    'XTickLabel', [" ", " ", " ", " ", " "], "XTickLabelRotation", 90);
set(gca, 'YTick', 1:23, 'TickDir', 'none', ...
    'YTickLabel', repmat(" ", 1, 23), "YTickLabelRotation", 0);
save_path_filename=strcat("../../results_bins/DRIVER/HCP/region_level/" + ...
    "bins_20_meta_HCP_schaefer200x17");
print(gcf, '-dpng', '-r1000', save_path_filename);
print(gcf, '-dmeta', save_path_filename);
close;


%% generate .nii files for meta analysis. (Fig. 2C)
addpath(genpath("D:\Program Files\MATLAB\R2023a\toolbox\dzjin\brainstat_matlab"));
...
rest1_lr = load("hcp_REST1_LR_schaefer200x17_group_roi_contribution.mat");
rest1_rl = load("hcp_REST1_RL_schaefer200x17_group_roi_contribution.mat");
rest2_lr = load("hcp_REST2_LR_schaefer200x17_group_roi_contribution.mat");
rest2_rl = load("hcp_REST2_RL_schaefer200x17_group_roi_contribution.mat");
cs = rest1_lr.roi_contri_group +  rest1_rl.roi_contri_group + rest2_lr.roi_contri_group +  rest2_rl.roi_contri_group;
cs = cs ./ 4;

parcellation = fetch_parcellation('fsaverage5', 'schaefer', 200);
for bin_i=1:20
    cs_bin_i = cs(:, bin_i);
    [~, roi_id_sorted] = sort(cs_bin_i, 'descend');
    cs_bin_i_masked = zeros(size(cs_bin_i));
    cs_bin_i_masked(roi_id_sorted(1:20)) = 1; 
    % load mni152 template.
    hdr=spm_vol('G:/datasets/atlas/Schaefer/Schaefer2018_200Parcels_17Networks_order_FSLMNI152_2mm.nii');
    data=spm_read_vols(hdr);
    num_of_roi = max(max(max(data)));
    h = hdr.dim;
    cofluc_socre_meta=zeros(h);
    for roi_i=1:num_of_roi
        cofluc_socre_meta(find(data==roi_i)) = cs_bin_i_masked(roi_i);
    end
    hdr.fname = char(strcat("./neurosynth_meta_analysis/hcp_bin_", num2str(bin_i), ".nii"));
    spm_write_vol(hdr, cofluc_socre_meta);
end
